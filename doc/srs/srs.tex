...
\selectlanguage{english}\color{black} Neural Network
Specification\\\hline
\selectlanguage{english}\color{black} MDP &
\selectlanguage{english}\color{black} Markov Decision Process
Specification\\\hline
